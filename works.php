...
<body background="dash1.jpg">
 <img src="user.svg" color="white" style="width:60px">    
...
//print_r(2423);exit;
	...
	$Status=$_POST['Status'];
	$sql="INSERT INTO works (ProjectTitle,Task,Description,StartTime,EndTime,Status) VALUES('$ProjectTitle','$Task','$Description','$StartTime','$EndTime','$Status')";
